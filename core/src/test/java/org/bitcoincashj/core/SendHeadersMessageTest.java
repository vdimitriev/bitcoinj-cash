...
public class SendHeadersMessageTest {
    ...
    public void decodeAndEncode() throws Exception {
        ...
        RegTestParams params = org.bitcoincashj.params.RegTestParams.get();
        BitcoinSerializer serializer = new BitcoinSerializer(params, false);
        assertTrue(serializer.deserialize(buffer) instanceof org.bitcoincashj.core.SendHeadersMessage);
    }
}
